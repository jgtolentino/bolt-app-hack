-- Drop the monitor_generation_progress function first to avoid return type error
...
-- Create the monitor_generation_progress function with correct return types
